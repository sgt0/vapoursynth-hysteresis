...
> the Avisynth function `mt_hysteresis`. Note that both clips are expected to be
> in the typical mask range which means that all planes have to be in the 0-1
> range for floating point formats.
>
